...
load(here::here("data/toad_as_character.RData"))
...
When thinking about whether frogs might be right or left handed, we are biased by the fact that humans are right handed.  But before we did the experiment, we might not have an expectation of whether, if a bias exists, its towards right-handedness or left-handedness.  We therefore should consider whether a bias of any kind exists.
